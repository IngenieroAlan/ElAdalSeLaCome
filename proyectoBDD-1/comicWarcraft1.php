    ...
    <header class="banner">
        ...
        <div class="perfil">
            <nav>
                ...
                <br><a href="inicio.php" class="regresar">Regresar</a>
    <h1 class="titulo">WORLD OF WARCRAFT</h1>
    <h2 class="titulo">Tres hermanas</h2>
    <object class="pdfview" data="comics/warcraft/Tres Hermanas.pdf" type="application/pdf"></object>
    <div class="botones">
        <a style="display: none;"><button>
            Capitulo Anterior
        </button></a>
        <a href="comicWarcraft2.html"><button>
            Siguiente Capitulo
        </button></a>
    </div>
</body>
