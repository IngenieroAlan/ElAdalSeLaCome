...
<body>
    ...
    <div class="pnlRegistro">
        ...
        <form method="post">
            ...
            <input type="date" name="fecha_nacimiento" value="<?php $hoy=date("Y-m-d"); echo $hoy;?>" max="<?php $hoy=date("Y-m-d"); echo $hoy;?>"><br>
            <label for="num_telefonico">Número telefonico</label><br>
            <input type="text" name="num_telefonico" id="num_telefonico"><br>
            <input type="submit" class="btnRegistrar" name="registro" value="Registrar" />
