    ...
    <div class="forma">
        ...
        <form method="post">
            ...
            <div>
                ...
                <input type="date" name="fecha_nacimiento" value="<?php echo $fecha_nacimiento; ?>" max="<?php $hoy=date("Y-m-d"); echo $hoy;?>"><br>
            </div>
            <div>
            ...
            <div class="forma">
                ...
                <input type="submit" name="salir" class="btn" value="Cerrar sesión" />
            </div>
        </form>
        <form method="post">
            ...
            <div>
                ...
                <input type="submit" class="btn" name="eliminar" value="Eliminar cuenta" />
            </div>
